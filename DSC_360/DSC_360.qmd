...
1.  Activities: 15 worth 3 pts. each = 45pts.

2.  Exercises: 15 worth 3 pts. each = 45pts.

3.  Final Project: 1 worth 67 pts. = 67 pts.

4.  In-class exams: 2 worth 34 pts. each = 68 pts.
...
There will be two in class exams, which will be effectively be activities/exercises under a time limit.

In general, no other extra credit work will be assigned.

## Collaboration Policy

The field of science is almost entirely collaborative. If students wish to collaborate on solving exercises or activities outside of class, this is allowed and encouraged under the condition that you explicitly note with who you collaborated. Each student must turn in their own copy of the work, each copy listing the collaborators. Please limit group work to two or three students. The corresponding responsibility is that each student is responsible for the course information. Collaboration is not allowed during exams.
